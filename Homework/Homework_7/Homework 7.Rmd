...
**Response:** The maximum of 0.5100 is obtained in one single iteration, however this was only obtained by initializing $x_k=1$. The maximization seems to become easily stuck regardless modifying initial $\gamma$ or $\beta$.
